...
class PanduanBayam : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.panduan_bayam)
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.panduan_bayam)) { v, insets ->
        ...
        topBarTitle.text = getString(R.string.panduan_perawatan_bayam)
        ...
        onBackPressedDispatcher.addCallback(
            this, object : OnBackPressedCallback(true){
                override fun handleOnBackPressed() {
                    val intent = Intent (this@PanduanBayam, ClueAgricultureActivity::class.java)
                    startActivity(intent)
                    finish()
                }
            }
