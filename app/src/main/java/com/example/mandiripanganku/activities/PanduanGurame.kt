...
class PanduanGurame : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.panduan_gurame)
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.panduan_gurame)) { v, insets ->
        ...
        topBarTitle.text = getString(R.string.panduan_perawatan_gurame)
        ...
        onBackPressedDispatcher.addCallback(
            this, object : OnBackPressedCallback(true){
                override fun handleOnBackPressed() {
                    val intent = Intent (this@PanduanGurame, ClueFisheryActivity::class.java)
                    startActivity(intent)
                    finish()
                }
            }
