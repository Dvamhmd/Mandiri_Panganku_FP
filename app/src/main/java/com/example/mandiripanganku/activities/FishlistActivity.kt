...
class FishlistActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.fishlist)) { v, insets ->
        ...
        topBarTitle.text = getString(R.string.perikananku)
        ...
        findViewById<View>(R.id.add).setOnClickListener {
            val intent = Intent(this, MyFisheryActivity::class.java)
            startActivity(intent)
        }
        ...
        onBackPressedDispatcher.addCallback(
            this, object : OnBackPressedCallback(true){
                override fun handleOnBackPressed() {
                    val intent = Intent (this@FishlistActivity, HomeActivity::class.java)
                    startActivity(intent)
                    finish()
                }
            }
