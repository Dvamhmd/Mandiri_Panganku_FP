...
class PanduanLele : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.panduan_lele)
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.panduan_lele)) { v, insets ->
        ...
        topBarTitle.text = getString(R.string.panduan_perawatan_lele)
        ...
        onBackPressedDispatcher.addCallback(
            this, object : OnBackPressedCallback(true){
                override fun handleOnBackPressed() {
                    val intent = Intent (this@PanduanLele, ClueFisheryActivity::class.java)
                    startActivity(intent)
                    finish()
                }
            }
