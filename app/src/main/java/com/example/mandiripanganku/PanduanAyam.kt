...
class PanduanAyam : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.panduan_ayam)
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.panduan_ayam)) { v, insets ->
        ...
        topBarTitle.text = getString(R.string.panduan_perawatan_ayam)
        ...
        onBackPressedDispatcher.addCallback(
            this, object : OnBackPressedCallback(true){
                override fun handleOnBackPressed() {
                    val intent = Intent (this@PanduanAyam, ClueFarmingActivity::class.java)
                    startActivity(intent)
                    finish()
                }
            }
