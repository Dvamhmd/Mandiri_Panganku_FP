...
class PanduanTomat : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.panduan_tomat)
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.panduan_tomat)) { v, insets ->
        ...
        topBarTitle.text = getString(R.string.panduan_perawatan_tomat)
        ...
        onBackPressedDispatcher.addCallback(
            this, object : OnBackPressedCallback(true){
                override fun handleOnBackPressed() {
                    val intent = Intent (this@PanduanTomat, ClueAgricultureActivity::class.java)
                    startActivity(intent)
                    finish()
                }
            }
